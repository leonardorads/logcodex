...
const cases = [
  {
    ...
    what: 'Site profissional + agendamento automático pelo WhatsApp',
    metric: '−3h/dia',
    metricLabel: 'em confirmações manuais',
    secondary: '−40% em faltas e no-shows',
    timeline: '18 dias',
  ...
  },
  {
    ...
    what: 'Site com formulário conectado ao WhatsApp + Google Meu Negócio',
    metric: '+35%',
    metricLabel: 'em novos clientes',
    secondary: 'Primeiros contatos em 48h no ar',
    timeline: '14 dias',
    tags: ['Site', 'Google', 'SEO'],
    Icon: Globe,
  ...
  },
  {
    ...
    what: 'Landing page institucional + integração com WhatsApp Business',
    metric: '+28',
    metricLabel: 'leads qualificados/mês',
    secondary: 'Presença no Google Maps em 7 dias',
    timeline: '21 dias',
    tags: ['Site', 'WhatsApp', 'Google Maps'],
    Icon: TrendingUp,
