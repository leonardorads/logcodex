...
export const alt =
  'LogCodex Fleet — Acesso Antecipado Lote 1: 30% de desconto por 12 meses para as 20 primeiras transportadoras'
    ...
    (
      ...
      >
        ...
        >
          ...
          {/* Headline — gradiente cyan→green grifado */}
          <div
            style={{
              display: 'flex',
              fontSize: 34,
          ...
          >
            Feito para transportadoras que querem parar de perder dinheiro no escuro.
          </div>
          ...
          >
            ...
            <span style={{ fontSize: 34, fontWeight: 700, color: '#22d3ee' }}>
              R$ 69,30
            </span>
          ...
          <div style={{ fontSize: 13, color: '#64748b', marginTop: '16px' }}>
            30% de desconto por 12 meses · Sem cartão · Sem compromisso
          </div>
        </div>
