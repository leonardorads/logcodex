export const FAQ = [
  ...
  { q: 'O sistema já funciona ou é promessa?', a: 'Já funciona. O Fleet está em produção numa transportadora real todos os dias. Você não está entrando numa lista de algo que talvez exista — está garantindo a condição de lançamento de um produto que já roda.' },
